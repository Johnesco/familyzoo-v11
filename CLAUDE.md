# Family Zoo — v11 — Non-Player Characters — Claude Project Memory
...
**Name:** Family Zoo — v11 — Non-Player Characters
**Purpose:** Sharpee tutorial step 11 — Non-Player Characters.
...
**Repository:** https://github.com/Johnesco/familyzoo-v11
**Live:** https://johnesco.github.io/familyzoo-v11/
...
├── familyzoo-11.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v11.story`.
